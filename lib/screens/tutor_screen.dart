...
""";
  ...
  Widget _buildQuiz() {
    ...
    final bgColor = isDark ? colorScheme.surface : const Color(0xFF000B2C);
    final cardBg = isDark ? colorScheme.surfaceContainerHigh : const Color(0xFF0A1545);
    ...
    final badgeBorder = isDark
        ? colorScheme.primary.withAlpha(128)
        : Colors.blue.withAlpha(128);
    final accentText = isDark ? colorScheme.primary : Colors.blue[300]!;
    final questionText = isDark ? colorScheme.onSurface : Colors.white;

    return ConfettiOverlay(
      isActive: _hasAnswered && _isCorrect == true,
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              bgColor,
              bgColor.withBlue(isDark ? (bgColor.b * 255.0).round().clamp(0, 255) : 80),
            ],
          ),
        ),
        child: Column(
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      final t = Curves.easeOutCubic.transform(
                        _questionController.value.clamp(0.0, 1.0),
                      );
                      return Opacity(
                        opacity: t,
...
class _MillionaireButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    Color baseColor = isDark ? Theme.of(context).colorScheme.surfaceContainer : const Color(0xFF0A1545);
    Color borderColor = isDark ? Theme.of(context).colorScheme.outline.withAlpha(128) : Colors.blue.withAlpha(128);
    Color textColor = isDark ? Theme.of(context).colorScheme.onSurface : Colors.white;
